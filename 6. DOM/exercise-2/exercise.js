...
const firstBtnElement = document.querySelector("button");
const secondBtnElement = document.getElementById("second-btn");
...
// firstBtnElement.addEventListener("click", removeParagraph);
// secondBtnElement.addEventListener("click", changeBackgroundColor);
